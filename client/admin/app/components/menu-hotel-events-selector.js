...
export default Ember.Component.extend({
  ...
  didInsertElement() {
    return this.get('store').query('hotel-event', {
      limit: 8,
  ...
  actions: {
    ...
    listaChecked() {
      ...
      // toggle page selection:
      if (pagesSelected['hotel-event_list']) {
        delete pagesSelected['hotel-event_list'];
      } else {
        pagesSelected['hotel-event_list'] = {
          isList: true,
          linkPermanent: '/hotel-event'
        };
      }
